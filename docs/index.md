...
Rich-codex is a command-line tool that you can run [via a GitHub action](usage/github_action.md) or as a [command line tool](usage/cli.md). It works with any markdown (including GitHub READMEs).
